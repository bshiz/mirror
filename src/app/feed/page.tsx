...
export default function FeedPage() {
  ...
  if (loading) return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 24, fontStyle: 'italic', color: '#6b7280' }}>
      Loading your feed...
    </div>
  )
  ...
  return (
    <>
      ...
      <div style={{ marginBottom: 36 }}>
        <h2 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 32, fontWeight: 800, letterSpacing: '-0.02em', lineHeight: 1.2 }}>
          {greeting}, <em style={{ fontStyle: 'normal', color: '#357FEC' }}>{profile?.name}.</em>
        </h2>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {reports.map(r => (
              <div
                ...
                style={{ background: 'white', border: '1px solid #ebebeb', borderRadius: 10, padding: '18px 22px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 20, transition: 'box-shadow 0.15s' }}
                onMouseEnter={e => (e.currentTarget.style.boxShadow = '0 2px 16px rgba(15,14,12,0.07)')}
                onMouseLeave={e => (e.currentTarget.style.boxShadow = 'none')}
              >
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 17, marginBottom: 4 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
                  <div style={{ background: '#ebebeb', borderRadius: 10, padding: '10px 14px', textAlign: 'center', minWidth: 52 }}>
                    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 24, fontStyle: 'italic', color: scoreColor(r.overall_score), lineHeight: 1 }}>
                      {r.overall_score}
                    </div>
                    <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 14, color: '#6b7280' }}>/ 10</div>
                  </div>
                  <span style={{ color: '#ebebeb', fontSize: 18 }}>›</span>
                </div>
              </div>
            ))}
          </div>
      ...
      {reports.length === 0 && (
        <div style={{ textAlign: 'center', padding: '60px 20px' }}>
          ...
          <h3 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 22, marginBottom: 8, color: '#1a1a1a' }}>No meetings yet</h3>
          <p style={{ fontSize: 16, color: '#6b7280', maxWidth: 320, margin: '0 auto 32px', lineHeight: 1.6 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, alignItems: 'center' }}>
            <button
              ...
              style={{ padding: '12px 24px', background: '#0f0e0c', color: '#ffffff', border: 'none', borderRadius: 4, fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 16, fontWeight: 500, cursor: 'pointer', width: 280 }}>
              Connect a meeting source →
            </button>
            <button
              onClick={() => router.push('/new')}
              style={{ padding: '12px 24px', background: 'none', color: '#1a1a1a', border: '1px solid #ebebeb', borderRadius: 4, fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 16, cursor: 'pointer', width: 280 }}>
